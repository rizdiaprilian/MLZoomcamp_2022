...
def main():
    ...
    st.write("mae", error_scores['mae'])
    st.write("mape", error_scores['mape'])
    st.write("mse", error_scores['mse'])
    st.write("rmse", error_scores['rmse'])
    st.write("aic", error_scores['aic'])
    st.write("bic", error_scores['bic'])
    st.write("explained_var", error_scores['explained_var'])
    st.write("r2", error_scores['r2'])
